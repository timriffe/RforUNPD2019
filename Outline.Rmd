...
Focus on `DemoTools` and `DDSQLtools` with systematic and comprehensive applications to `MS-SQL DemoData` empirical data for population by age and sex, vital events and rates.

Use of `git` and `github` for code repository and teamwork.

One or two data visualization lectures.
