...
With this as our inspiration, let's write our own lifetable function. In the first instance, let's use them in a tidy pipeline. For this, use this big HMD dataset, here:
